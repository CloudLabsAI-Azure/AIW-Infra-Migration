## Exercise 2: Migrate the Virtual Machine to Azure

### Estimated duration: 140 Minutes

## Overview

In this exercise, you will use Azure Migrate and Azure Site Recovery to replicate an on-premises virtual machine to Azure, configure the target networking settings, perform a test migration, and complete the final migration to Azure.
